package com.banderasmusic.ecommerceproductapi.controller;

import com.banderasmusic.ecommerceproductapi.exceptions.HTTP400Exception;
import com.banderasmusic.ecommerceproductapi.exceptions.HTTP404Exception;
import com.banderasmusic.ecommerceproductapi.exceptions.HTTP500Exception;
import com.banderasmusic.ecommerceproductapi.exceptions.RestAPIExceptionInfo;
...
public abstract class AbstractController implements ApplicationEventPublisherAware {
    ...
    Counter http400ExceptionCounter = Metrics.counter("com.banderasmusic.ProductController.HTTP400");
    Counter http404ExceptionCounter = Metrics.counter("com.banderasmusic.ProductController.HTTP404");
    Counter http500ExceptionCounter = Metrics.counter("com.banderasmusic.ProductController.HTTP500");
    ...
    public @ResponseBody RestAPIExceptionInfo handleInternalServerException(HTTP500Exception ex, WebRequest request,
                                                                        HttpServletResponse response) {
